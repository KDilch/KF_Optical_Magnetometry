...
class Hajimolahoseini_Measurement_Model(MeasurementModel):
    def __init__(self,
                 simulation_params,
                 logger=None
                 ):
        ...
        self.__z = simulation_params.x_0[1]
        self.__z_no_noise = simulation_params.x_0[1]

    def read_sensor(self, state):
        self.__z_no_noise = self._measurement_strength * self._H.dot(state) * self._dt
